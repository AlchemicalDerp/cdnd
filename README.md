...
1. In Prism Launcher click **Add Instance → Import**.
2. Paste this link and click OK:

   ```
   https://github.com/AlchemicalDerp/cdnd/releases/latest/download/cd-d-prism.zip
   ```
3. Launch it. [unsup](https://git.sleeping.town/exa/unsup) downloads the mods on first launch and keeps the pack updated every time you start the game.
...
| Name | Side | Source |
|---|---|---|
| 3D Skin Layers | client | [modrinth](https://modrinth.com/project/zV5r3pPn) |
...
| AppleSkin | both | [modrinth](https://modrinth.com/project/EsAfCjCV) |
...
| Collective | both | [modrinth](https://modrinth.com/project/e0M1UDsY) |
| Comforts | both | [modrinth](https://modrinth.com/project/SaCpeal4) |
| Concurrent Chunk Management Engine (NeoForge) | both | [modrinth](https://modrinth.com/project/COlSi5iR) |
| Continents | both | [modrinth](https://modrinth.com/project/bQ5TJA1E) |
...
| Create Deep Seas | both | [modrinth](https://modrinth.com/project/mva5q4qZ) |
| Create Propulsion: Simulated | both | [modrinth](https://modrinth.com/project/ApkoHNO9) |
| Create Stuff 'N Additions | both | [modrinth](https://modrinth.com/project/aq9qUUQG) |
| Create Stuff N' Additions Curios Compat | both | [modrinth](https://modrinth.com/project/1eKmkIZD) |
| Create: Aeroworks | both | [modrinth](https://modrinth.com/project/P26k79kP) |
| Create: Bits 'n' Bobs | both | [modrinth](https://modrinth.com/project/T8bvmqVZ) |
| Create: Coasters Simulated | both | [modrinth](https://modrinth.com/project/W1ZUfWdr) |
| Create: Compact Flap | both | [modrinth](https://modrinth.com/project/Rsk2MfzV) |
| Create: Compact Transmission | both | [modrinth](https://modrinth.com/project/qBkvR8oH) |
| Create: Connected | both | [modrinth](https://modrinth.com/project/Vg5TIO6d) |
...
| Curios API | both | [modrinth](https://modrinth.com/project/vvuO3ImH) |
| Cut Through | client | [modrinth](https://modrinth.com/project/Dk6su9JN) |
| Dashpanels | both | [modrinth](https://modrinth.com/project/xZJfGh82) |
| Dashpanels: Expanded | both | [modrinth](https://modrinth.com/project/gazFBp5k) |
| Dashpanels: Extra | both | [modrinth](https://modrinth.com/project/bPbnsb3f) |
| Diagonal Fences | both | [modrinth](https://modrinth.com/project/IKARgflD) |
| Diagonal Walls | both | [modrinth](https://modrinth.com/project/FQgc8dib) |
| Diagonal Windows | both | [modrinth](https://modrinth.com/project/oOi0CKes) |
| Distant Horizons | both | [modrinth](https://modrinth.com/project/uCdwusMi) |
| Easy Anvils | both | [modrinth](https://modrinth.com/project/OZBR5JT5) |
| Easy Shulker Boxes | both | [modrinth](https://modrinth.com/project/gA5euN8S) |
| Euphoria Patches | client | [modrinth](https://modrinth.com/project/4H6sumDB) |
| Exposure | both | [modrinth](https://modrinth.com/project/hB899VmG) |
| Exposure Catalog | both | [modrinth](https://modrinth.com/project/PWcQ3kcp) |
| Falling Leaves (NeoForge/Forge) | client | [modrinth](https://modrinth.com/project/2JAUNCL4) |
| Farmer's Delight | both | [modrinth](https://modrinth.com/project/R2OftAxM) |
| FerriteCore | both | [modrinth](https://modrinth.com/project/uXXizFIs) |
| Forgified Fabric API | both | [modrinth](https://modrinth.com/project/Aqlf1Shp) |
...
| Iceberg | both | [modrinth](https://modrinth.com/project/5faXoLqX) |
| Illager Invasion | both | [modrinth](https://modrinth.com/project/jSV9w0J5) |
| Incapacitated | both | [modrinth](https://modrinth.com/project/CmDgNtOI) |
| Iris Shaders | client | [modrinth](https://modrinth.com/project/YL57xq9U) |
| ItemPhysic | both | [modrinth](https://modrinth.com/project/aT8BzaOj) |
...
| Mouse Tweaks | client | [modrinth](https://modrinth.com/project/aC3cM3Vq) |
| Nemo's Inventory Sorting | client | [modrinth](https://modrinth.com/project/JHgf35QL) |
| Not Enough Animations | client | [modrinth](https://modrinth.com/project/MPCX6s5C) |
| Particle Core | client | [modrinth](https://modrinth.com/project/RSeLon5O) |
| Particle Rain *(optional)* | both | [modrinth](https://modrinth.com/project/nrikgvxm) |
| Platform | both | [modrinth](https://modrinth.com/project/i6fiqm5y) |
| playerAnimator | both | [modrinth](https://modrinth.com/project/gedNE4y2) |
| Polymorph | both | [modrinth](https://modrinth.com/project/tagwiZkJ) |
| Prism | client | [modrinth](https://modrinth.com/project/1OE8wbN0) |
...
| Serene Seasons | both | [modrinth](https://modrinth.com/project/e0bNACJD) |
| Shulker Box Tooltip | both | [modrinth](https://modrinth.com/project/2M01OLQq) |
...
| Steam 'n' Rails Neoforge | both | [modrinth](https://modrinth.com/project/L3Jv0QZI) |
| Strut Your Stuff (Struts) | both | [modrinth](https://modrinth.com/project/sHO3MhQx) |
| Supplementaries | both | [modrinth](https://modrinth.com/project/fFEIiSDQ) |
| Synaxis | both | [modrinth](https://modrinth.com/project/aJewFWOb) |
| Tectonic | both | [modrinth](https://modrinth.com/project/lWDHr9jE) |
| TerraBlender | both | [modrinth](https://modrinth.com/project/kkmrDlKT) |
...
| Name | Side | Source |
|---|---|---|
| Complementary Shaders - Unbound | both | [modrinth](https://modrinth.com/project/R6NEzAwj) |

---
*Built with Packwright · packwiz · unsup*
